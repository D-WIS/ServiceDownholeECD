...
namespace DWIS.Service.DownholeECD.ModelSharedOut
{
    /// <summary>
    ...
    class Program
    {
        ...
        private static readonly string JSON_BUNDLE = "DownholeECDMergedModel.json";
        private static readonly string CSHARP_MODEL = "DownholeECDMergedModel.cs";
        private static readonly string PSEUDO_CTOR = "PseudoConstructors.cs";

        // ### BEGIN CODE SPECIFIC TO ModelSharedOut 3/3 ###
        private static readonly string NAMESPACE = "DWIS.Service.DownholeECD.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
        private static readonly string MODELSHARED_FOLDER = "DWIS.Service.DownholeECD.ModelSharedOut";
        private static readonly string JSON_OUTPUT_FOLDER = "DWIS.Service.DownholeECD.Service" + Path.DirectorySeparatorChar + "wwwroot" + Path.DirectorySeparatorChar + "json-schema";
        ...
        static bool CreatePseudoConstructors(DirectoryInfo directory)
        {
            ...
            string nspace = "DWIS.Service.DownholeECD.ModelShared";
